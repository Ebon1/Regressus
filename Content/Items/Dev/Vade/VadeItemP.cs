...
namespace Regressus.Content.Items.Dev.Vade
{
    public class VadeItemP : HeldSword
    {
        ...
        {
            Texture2D glow = ModContent.Request<Texture2D>("Regressus/Content/Items/Dev/Vade/VadeItemP_Glow").Value;
            Player player = Main.player[Projectile.owner];
    ...
    {
        public override string Texture => "Regressus/Content/Items/Dev/Vade/VadeItemP";
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Tyrfing");
        }
    ...
    {
        public override string Texture => "Regressus/Content/Items/Dev/Vade/VadeItem";
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Tyrfing");

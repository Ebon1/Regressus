...
namespace Regressus.Content.Items.Misc.SproutingPan
{
    ...
    {
        public override string Texture => "Regressus/Content/Items/Misc/SproutingPan/PvZBase";
        ...
        {
            Texture2D tex = RegreUtils.GetTexture("Regressus/Content/Items/Misc/SproutingPan/PvZHead" + (Tier + 1));

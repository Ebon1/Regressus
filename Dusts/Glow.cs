...
namespace Regressus.Dusts
{
    public class Glow : ModDust
	{
		public override void OnSpawn(Dust dust)
		{
			...
			dust.shader = new Terraria.Graphics.Shaders.ArmorShaderData(new Ref<Effect>(Regressus.Instance.Assets.Request<Effect>("Effects/GlowingDust", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value), "GlowingDustPass");
		}

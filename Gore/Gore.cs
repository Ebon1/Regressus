...
namespace Regressus
{
    ...
    public class Facade1 : ModGore
    {
        public override string Texture => "Regressus/Gore/" + this.Name;
        public override void SetStaticDefaults() => GoreID.Sets.SpecialAI[Type] = 0;
    }
    public class Facade2 : ModGore
    {
        public override string Texture => "Regressus/Gore/" + this.Name;
        public override void SetStaticDefaults() => GoreID.Sets.SpecialAI[Type] = 0;
    }
    public class Facade3 : ModGore
    {
        public override string Texture => "Regressus/Gore/" + this.Name;
        public override void SetStaticDefaults() => GoreID.Sets.SpecialAI[Type] = 0;
    }
    public class Facade4 : ModGore
    {
        public override string Texture => "Regressus/Gore/" + this.Name;
        public override void SetStaticDefaults() => GoreID.Sets.SpecialAI[Type] = 0;
    }
    public class Facade_Death1 : ModGore
    {
        public override string Texture => "Regressus/Gore/" + this.Name;
        public override void SetStaticDefaults() => GoreID.Sets.SpecialAI[Type] = 0;
    }
    public class Facade_Death2 : ModGore
    {
        public override string Texture => "Regressus/Gore/" + this.Name;
        public override void SetStaticDefaults() => GoreID.Sets.SpecialAI[Type] = 0;
    }

...
namespace Regressus.Projectiles.Magic
{
    ...
    public class VisionP2 : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D bolt = RegreUtils.GetExtraTexture("Tentacle");
            ...
            for (int i = 0; i < num; i++)
            {
                Main.spriteBatch.Draw(bolt, vector2 - Main.screenPosition, null, Color.Purple, rotation, bolt.Size() / 2, new Vector2(1, Projectile.scale), SpriteEffects.None, 0f);

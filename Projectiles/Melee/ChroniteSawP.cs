...
{
    public class ChroniteSawP : ModProjectile
    {
        public override string Texture => "Regressus/Items/Weapons/Melee/ChroniteSaw";
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Chronite Saw");
        }
        float holdOffset;
        int SwingTime;
        ...
        {
            target.velocity.X *= (0.25f * target.knockBackResist);
        }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (Projectile.localAI[0] > 0)
            {
                ...
                Main.spriteBatch.Draw(texture, Projectile.Center - Main.screenPosition, null, Color.White, Projectile.rotation + (Projectile.direction == 1 ? 0 : MathHelper.PiOver2 * 3), texture.Size() / 2, Projectile.scale, Projectile.direction == 1 ? SpriteEffects.None : SpriteEffects.FlipVertically, 0f);
            }
            return false;
        }
    }

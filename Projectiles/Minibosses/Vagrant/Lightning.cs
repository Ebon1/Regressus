...
public class Lightning : ModProjectile
{
    ...
    private const float Randomness = 35f;
...
public class LightningF : ModProjectile
{
    public override string Texture => "Terraria/Images/Projectile_" + ProjectileID.StardustTowerMark;
    public override void SetDefaults()
    {
    ...
    {
        float a = float.NaN;
        return Collision.CheckAABBvLineCollision(targetHitbox.TopLeft(), targetHitbox.Size(), Projectile.Center - Vector2.UnitY * 500, Projectile.Center + Vector2.UnitY * 500, Thickness, ref a);
    }
    public void GenerateLightning(Vector2 start, Vector2 end)
    {
        Points.Clear();
...
public class Lightning2 : ModProjectile
{
    public override string Texture => "Terraria/Images/Projectile_" + ProjectileID.StardustTowerMark;
    public override void SetDefaults()
    {
    ...
    public override void AI()
    {
        if (Projectile.localAI[0] == 0)
        {
            ...
            GenerateLightning(Projectile.Center, npc.Center);
            SoundStyle style = new SoundStyle("Regressus/Sounds/Custom/thunder");
            style.PitchVariance = 1;
            style.MaxInstances = 0;
            style.Volume = 2f - Projectile.ai[1];
    ...
    private const float Randomness = 15f;

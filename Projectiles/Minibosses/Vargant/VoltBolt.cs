...
namespace Regressus.Projectiles.Minibosses.Vargant
{
    public class VoltBolt : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Vector2 end = Projectile.Center + Projectile.velocity * RegreUtils.TRay.CastLength(Projectile.Center, Projectile.velocity, 5000);
        ...
        {
            float _ = float.NaN;
            Vector2 beamEndPos = Projectile.Center + Projectile.velocity * RegreUtils.TRay.CastLength(Projectile.Center, Projectile.velocity, 5000);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D bolt = RegreUtils.GetExtraTexture("Extras2/spark_06");
            ...
            BeamColor = Color.LightGoldenrodYellow;
            ...
            Main.spriteBatch.Draw(texture, Projectile.Center - Main.screenPosition, null, Color.Gold, 0, new Vector2(texture.Width, texture.Height) / 2, scale * 0.25f, SpriteEffects.None, 0f);

            texture = ModContent.Request<Texture2D>("Regressus/Extras/Extras2/light_01").Value;
            for (int i = 0; i < 5; i++)
                Main.spriteBatch.Draw(texture, end - Main.screenPosition, null, Color.Gold, Projectile.rotation, new Vector2(texture.Width, texture.Height) / 2, scale * 0.15f, SpriteEffects.None, 0f);

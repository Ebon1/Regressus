...
{
    internal class TentacleRT : ModProjectile
    {
        public override string Texture => "Regressus/Extras/Tentacle_purple";
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (bars.Count > 2)
            {
                ...
                Regressus.TentacleRT.Parameters[0].SetValue(model * projection);
                Regressus.TentacleRT.CurrentTechnique.Passes[0]
                    .Apply();
    ...
    internal class SmolTentacleRT : ModProjectile
    {
        public override string Texture => "Regressus/Extras/laser_purple";
        private List<float> rots;

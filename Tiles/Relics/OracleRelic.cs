...
{
    public class OracleRelic : ModTile
    {
        ...
        protected int ItemType = ModContent.ItemType<OracleRelicItem>();

        private const string path = "Regressus/Tiles/Relics/";
        ...
        public override void SpecialDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Vector2 worldPos = p.ToWorldCoordinates(24f, 64f); //THESE NUMBERS CHANGE THE OFFSET
            ...
            Texture2D b = RegreUtils.GetExtraTexture("star_01");
            spriteBatch.Reload(BlendState.Additive);
            spriteBatch.Draw(a, drawPos, null, Color.White, -Main.GameUpdateCount * 0.0075f, a.Size() / 2, 0.45f, SpriteEffects.None, 0f);
            spriteBatch.Draw(b, drawPos, null, Color.White, -Main.GameUpdateCount * 0.005f, a.Size() / 2, 0.45f, SpriteEffects.None, 0f);
            ...
            {
                spriteBatch.Draw(texture, drawPos + (TwoPi * num5).ToRotationVector2() * (6f + offset * 35f), frame, effectColor, 0f, origin, 1f, effects, 0f);
            }
        }
    }
}
